...
public class Snowflake {
    ...
    private static final List<Snowflake> CACHE = new ArrayList<>();
    static {
        for (int i = 0; i < 10; i++) {
            CACHE.add(new Snowflake(i));
        }
    }

    public static Snowflake valueOfNodeId(final int nodeId) {
        Snowflake snowflake = CACHE.get(nodeId);
